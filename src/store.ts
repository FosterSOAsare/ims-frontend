...
import departmentRequestsApi from "./apis/departmentRequestsApi";
...
const middlewares: Array<Middleware> = [
  ...
  departmentRequestsApi.middleware,
]
...
const makeStore = () => (
  configureStore({
    reducer: {
      ...
      [departmentRequestsApi.reducerPath]: departmentRequestsApi.reducer
    },
